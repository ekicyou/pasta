...
```markdown
各フェーズの仕様では:
- 現在フェーズの DoD（完了基準）への貢献を明記
- DoD達成に必要な関連タスクも含める
- フェーズ完了を部分達成ではなく完全達成とする

例（Phase 2）:
- リリースワークフロー仕様では、DLL生成・ZIPパッケージ・CI/CD全体をスコープに含める
- 部分実装を「MVP」と称して完了宣言しない
```
