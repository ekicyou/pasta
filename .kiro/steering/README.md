...
### 2.5. [grammar.md](./grammar.md) - 文法ステアリング 🆕
**Pasta DSL 文法仕様へのポインターとクイックリファレンス**

- **権威的仕様書**: `/SPECIFICATION.md`（開発者向け、全11章1,210行）
- **利用者向けドキュメント**: `/GRAMMAR.md`（学習用）
- マーカー一覧（全角/半角対応表）
- 破壊的変更（2025-12適用済み）:
  - Jump（？）廃止 → Call（＞）使用
  - Sakura エスケープ/括弧: 半角のみ
- 主要パターン例

**読むべきタイミング**: パーサー・トランスパイラー実装時、文法確認時
