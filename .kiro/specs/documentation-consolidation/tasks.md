...
- [x] 5. ドキュメント保守ガイドラインを策定し、アーカイブを整理する
- [x] 5.1 workflow.md にドキュメント保守セクションを追加
...
- [x] 5.2 .kiro/specs/ 配下の完了済み仕様を再評価し、削除対象をリストアップ
...
- [x] 5.3 削除候補リストを開発者に提示し、承認後に削除実行
  - 削除候補リストを開発者に提示
  - 開発者承認後、対象仕様をgit操作で削除（44件削除、5件保持）
  - コミットメッセージに削除理由を記載
  - アーカイブ整理完了をドキュメント化
  - _Requirements: 8.5_
