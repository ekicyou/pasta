...
- [ ] 3. README.md を拡充し、ドキュメントマップとオンボーディングパスを追加する
- [ ] 3.1 ドキュメントマップセクションを追加
  - 新規セクション「ドキュメントマップ」を作成
  - 4階層構造（Level 0-3）を明示
  - 各レベルに属するドキュメントへのリンク設定
  - _Requirements: 2.1, 2.2, 3.1_

- [ ] 3.2 オンボーディングパスセクションを追加
