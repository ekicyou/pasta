...
### Option A: Minimal Viable (推奨)

**戦略**: 最小限の画像（単色シルエット）で素早くリリース

| 項目 | 内容 |
|------|------|
| 画像 | 単色シルエット（頭・胴・足の3パーツ楕円） |
| 表情 | テキスト描画（"^ ^", "- -" 等） |
...
### Option B: Enhanced Pictogram

**戦略**: ピクトグラム風の人型アイコン

| 項目 | 内容 |
|------|------|
| 画像 | 標識風人型アイコン（頭・手・足を線画） |
| 表情 | 顔部分に記号描画 |
| 色 | 白ベース + アクセントカラー |
| 工数 | 4-5日 |
...
### 4.1 推奨アプローチ: Option A (Minimal Viable)

**理由**:
1. アルファリリース目標に最適なリスク/工数バランス
2. 「著作権問題なし」「CI再現可能」要件を確実に満たす
3. 後からOption Bへアップグレード可能
