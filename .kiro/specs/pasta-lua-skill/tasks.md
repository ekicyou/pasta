...
- [x] 1. SKILL.mdファイルの骨格とメタデータ・目的セクションを準備する
- [x] 1.1 YAML Frontmatterを作成してスキルのトリガーフレーズを定義する
...
- [x] 1.2 §1 Purpose & Prerequisitesセクションを書く
...
- [x] 3. §3 Luaコーディング規約セクションを作成する
- [x] 3.1 命名規約・モジュール構造・循環参照回避パターンを書く
...
- [x] 3.2 クラス設計パターン（MODULE/MODULE_IMPL分離・コンストラクタ・継承・禁止パターン）を書く
...
- [x] 3.3 EmmyLua型注釈とエラーハンドリング規約を書く
...
- [x] 4. §4 ランタイムAPIリファレンスセクションを作成する
- [x] 4.1 @pasta_search・@pasta_persistence・@pasta_configモジュールを書く
...
- [x] 4.2 @pasta_sakura_script・@enc・mlua-stdlibモジュールを書く
...
- [x] 5. §5 pasta内部Luaモジュール解説セクションを作成する
- [x] 5.1 STOREパターンとACTオブジェクトを書く
...
- [x] 5.2 SCENE・WORD・GLOBAL・SAVE・finalize_sceneを書く
...
- [x] 6. §6 SHIORIイベントハンドラセクションを作成する
- [x] 6.1 REGテーブル登録パターンとRESレスポンス生成を書く
...
- [x] 6.2 主要SHIORIイベント一覧・シーン関数フォールバック・仮想ディスパッチャを書く
...
- [x] 7. §7 テスト・Lint規約セクションを作成して最終確認する
- [x] 7.1 lua_testフレームワーク・テストファイル規約・決定論的テストを書く
...
- [x] 7.2 luacheck設定を書いてSKILL.md全体の品質を最終確認する
