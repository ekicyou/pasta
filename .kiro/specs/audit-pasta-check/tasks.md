...
- [ ] 1. ファイルコピーの安全性強化
- [ ] 1.1 (P) copy.rsにシンボリックリンクスキップとパストラバーサル防御を追加
...
- [ ] 2. NARアーカイブ作成の安全性強化
- [ ] 2.1 (P) nar.rsにシンボリックリンクスキップとZIPエントリ名検証を追加
...
- [ ] 3. 更新ファイル生成のデッドコード除去と安全性強化
- [ ] 3.1 (P) update_files.rsからデッドコード除去、シンボリックリンクスキップ追加、MD5コメント追記
