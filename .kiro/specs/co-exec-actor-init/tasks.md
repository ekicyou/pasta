...
- [x] 2. `BUILDER.build` のインターフェース簡素化
- [x] 2.1 (P) 直接変更方式への移行
...
- [x] 5. (P) `config_actors_initialization_test.rs` の更新
...
- [x] 7. ドキュメント整合性の確認と更新
  ...
  - [x] GRAMMAR.md - 文法リファレンスの同期（該当する場合）
  - [x] TEST_COVERAGE.md - 新規テストのマッピング追加
  - [x] クレートREADME - API変更の反映（該当する場合）
