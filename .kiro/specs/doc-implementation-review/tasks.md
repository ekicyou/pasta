...
- [ ] 1. doc/spec/ディレクトリの作成とインデックス構築 (P)
- [ ] 1.1 (P) doc/spec/ディレクトリを作成しREADME.mdを配置
...
- [ ] 1.2 (P) SPECIFICATION.mdから章別ファイルを抽出
...
- [ ] 2. steering/grammar.mdをAI向け完全参照として再定義 (P)
- [ ] 2.1 (P) 役割説明セクションの追加
...
- [ ] 3. Level 1ドキュメントのヒエラルキー再定義
- [ ] 3.1 (P) SOUL.mdのLevel 2定義を更新
...
- [ ] 5. ドキュメント整合性の確認と更新
- [ ] 5.1 SOUL.mdとの整合性確認
  - コアバリュー（日本語フレンドリー、UNICODE識別子、yield型、宣言的フロー）への影響確認
  - 設計原則（行指向文法、前方一致、UI独立性）への影響確認
  - _Requirements: 1_
