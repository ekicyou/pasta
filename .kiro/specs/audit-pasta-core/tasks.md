...
- [ ] 1. 基盤: コンパイラ警告調査とデッドコード特定
- [ ] 1.1 pasta_coreの現状警告・デッドコード全数調査
...
- [ ] 3. コア: SceneTable のパニック安全化とリファクタリング
- [ ] 3.1 キャッシュ処理の共通ヘルパー抽出
...
- [ ] 4. コア: WordTable のパニック安全化
- [ ] 4.1 (P) WordTable のインデックスアクセス安全化
...
- [ ] 5. コア: デッドコード除去と冗長表現削減
- [ ] 5.1 (P) 全ファイルのデッドコード除去
