...
- [ ] 3. 不要依存の分析と除去
- [ ] 3.1 cargo-treeによる依存ツリー分析と未使用依存の特定を行う
...
- [ ] 3.2 特定された未使用依存をCargo.tomlから除去し、回帰テストを実行する
...
- [ ] 4.2 マイナー/パッチバージョンの更新候補を調査し、安全な更新を実施する (P)
...
- [ ] 5. MD5用途適切性の統合評価
- [ ] 5.1 MD5クレートの全使用箇所を調査し、用途の適切性を統合的に評価・文書化する
