...
- [ ] 4.1 CodeGenerator で現在のグローバルモジュール名を取得
...
- [ ] 5.1 (P) collect_scene_candidates メソッドのテスト
...
- [ ] 5.2 (P) resolve_scene_id メソッドのテスト
...
- [ ] 7.2 fixtures ディレクトリの確認と機能デモ fixture 追加（オプション）
  - `＞＊` 構文使用箇所を確認（調査済み: 0件）
  - [ ]* 統合スコープ検索の挙動を示す新しい fixture を追加
