...
- [ ] 4. alpha01-shiori-alpha-events の仕様初期化コマンド作成
...
- [ ] 5. alpha02-virtual-event-dispatcher の仕様初期化コマンド作成
...
- [ ] 8. (P) alpha05-build-ci の仕様初期化コマンド作成
  - `/kiro-spec-init` コマンド文字列の作成
...
- [ ] 9. alpha06-release-packaging の仕様初期化コマンド作成
  - `/kiro-spec-init` コマンド文字列の作成
