...
- [ ] 2. §1 Purpose & Prerequisites と §2 Quick Reference の記述
- [ ] 2.1 §1 Purpose & Prerequisites の記述
...
- [ ] 2.2 §2 Quick Reference マーカー一覧表の記述
  - 全マーカー（`＊`, `・`, `＠`, `＄`, `＞`, `＆`, `＃`, `％`, `！`）の全角・半角・用途を表形式で記述する
  - `steering/grammar.md` のマーカー一覧と一致することを確認する
  - _Requirements: 2.1, 6.2_

- [ ] 3. §3 DSL Syntax 各構文サブセクションの記述
- [ ] 3.1 シーン定義・アクション行・単語定義の記述
...
- [ ] 5. §6 Authoring Patterns 辞書制作パターン集の記述
- [ ] 5.1 アクター辞書・イベントハンドラ・ランダムトーク・単語選択パターンの記述
