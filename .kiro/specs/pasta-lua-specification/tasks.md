...
- [ ] 1.1 LuaTranspiler 構造体と基本的なトランスパイル処理フロー実装 (P)
...
- [ ] 1.2 StringLiteralizer による Lua 文字列リテラル化処理 (P)
...
- [ ] 1.3 Parser インテグレーションと AST 構造体マッピング (P)
...
- [ ] 4.1 TranspileError 列挙型と Display トレイト実装
...
- [ ] 5.1 sample.pasta → Lua トランスパイル統合テスト (P)
