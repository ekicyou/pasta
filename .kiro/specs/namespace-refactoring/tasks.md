...
- [ ] 1. (P) transpiler/ ドメインを整備する

- [ ] 1.1 transpiler/ サブディレクトリと main.rs を作成する
...
- [ ] 1.2 transpiler/ 系 7 ファイルを移動し common 参照を修正する
...
- [ ] 2. (P) loader/ ドメインを整備する

- [ ] 2.1 loader/ サブディレクトリと main.rs を作成する
...
- [ ] 2.2 loader/ 系 6 ファイルを移動し重複ヘルパーを排除する
  - `git mv` で下記ファイルを移動する:
...
- [ ] 3. (P) shiori/ ドメインを整備する

- [ ] 3.1 shiori/ サブディレクトリと main.rs を作成する
...
- [ ] 3.2 shiori/ 系 5 ファイルを移動し重複ヘルパーを排除する
  - `git mv` で下記ファイルを移動する:
...
- [ ] 4. (P) runtime/ ドメインを整備する

- [ ] 4.1 runtime/ サブディレクトリと main.rs を作成する
...
- [ ] 4.2 runtime/ 系 8 ファイルを移動し common 参照・重複を修正する
...
- [ ] 5. (P) log/ / sakura_script/ / search/ ドメインを一括整備する

- [ ] 5.1 log/ を整備し 3 ファイルを移動する
...
- [ ] 5.2 sakura_script/ を整備し 2 ファイルを移動・修正する
...
- [ ] 5.3 search/ を整備し 2 ファイルを移動・修正する
...
- [ ] 8. src/ レビュー結果の記録と steering を更新する

- [ ] 8.1 pasta_lua/src/ のモジュール配置を検証し結果を確定する
...
- [ ] 8.2 steering/structure.md をリファクタリング後の実体に同期する
