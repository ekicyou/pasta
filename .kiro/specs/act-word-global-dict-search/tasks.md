...
- [ ] 2. pasta.word モジュールへ値解決ロジック追加
- [ ] 2.1 WORD.resolve_value() 関数実装
  - `nil` の場合は `nil` を返す
...
- [ ] 3. ACT_IMPL.word 実装（act.lua）
- [ ] 3.1 シーン・GLOBAL完全一致検索実装
