...
- [x] 1. (P) キューコマンド専用トークンタイプを LSP サーバーに追加する
...
- [x] 2. VSCode 拡張にキューコマンドの設定を追加する

- [x] 2.1 (P) package.json にセマンティックトークンタイプとスコープマッピングを登録する
...
- [x] 2.2 (P) TextMate 文法にキューコマンド行パターンを追加する
...
- [x] 3. キューコマンド行のセマンティックトークン生成を実装する
  - タスク 1 完了後に着手（CUE_MARKER / CUE_COMMAND 定数が必要）

- [x] 3.1 マーカーとコマンド名のトークン生成を実装する
...
- [x] 4. 統合テストを追加してキューコマンドのトークン生成を検証する

- [x] 4.1 キューコマンドの基本 4 形式のトークン生成をテストする
