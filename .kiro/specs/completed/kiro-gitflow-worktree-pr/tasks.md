...
- [x] 1. 権威ソース（workflow.md §3）の PR ベース改訂
...
- [x] 2. kiro-complete の PR 化と決定的解決
...
- [x] 5. kiro-start のハーネスワークツリー委譲整合
...
- [x] 7. GitHub リポジトリの squash 限定設定（一度きり）
