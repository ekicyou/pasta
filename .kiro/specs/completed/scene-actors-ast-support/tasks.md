...
- [x] 1.1 (P) SceneActorItem構造体を定義する
...
- [x] 1.2 (P) GlobalScopeScopeにactorsフィールドを追加する
...
- [x] 2.1 parse_actors_item関数を実装する
...
- [x] 2.2 parse_scene_actors_line関数を実装する
...
- [x] 2.3 parse_global_scene_scopeを拡張する
