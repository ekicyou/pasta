...
- [x] 2. (P) 標準ランタイムディレクトリをリネームする

- [x] 2.1 ディレクトリを git mv でリネームする
...
- [x] 2.2 main.lua 内のコメントを更新する
  - `pasta_scripts/main.lua` 内のコメント中にある `user_scripts` パス参照を `scripts` に更新する
  - ロジック自体は変更しない（コメント文字列のみの修正）
  - _Requirements: 2.2_

- [x] 3. (P) ディレクトリの役割 README.md を配置する

- [x] 3.1 (P) pasta_scripts/README.md を配置する
...
- [x] 3.2 (P) scripts/README.md を配置する
...
- [x] 4. (P) hello.lua 関連ファイルをすべて削除する

- [x] 4.1 (P) hello.lua を削除する
  - `crates/pasta_lua/pasta_scripts/hello.lua` を `git rm` で削除する
  - _Requirements: 2.6_

- [x] 4.2 (P) transpiler_test.lua および init.lua エントリを削除する
...
- [x] 6. (P) テストコードのパス参照を新ディレクトリ構成に更新する

- [x] 6.1 (P) pasta_lua テストヘルパーのパス参照を更新する
...
- [x] 6.2 (P) ローダーテストのアサーションと一時ディレクトリ設定を更新する
...
- [x] 6.4 (P) pasta_sample_ghost テストのパス参照を更新する
...
- [x] 7. (P) ドキュメントとステアリングを新構成に更新する

- [x] 7.1 (P) ステアリング構造ファイルを更新する
...
- [x] 7.2 (P) pasta_lua README.md を更新する
...
- [x] 7.3 (P) pasta_sample_ghost ドキュメントを更新する
...
- [x] 7.4 (P) TEST_COVERAGE.md を更新する
  - `TEST_COVERAGE.md` の `user_scripts` テスト名を新パス名に更新する
  - _Requirements: 5.4_

- [x] 7.5 (P) AIスキルファイルのパス参照を更新する
