...
- [x] 10.1 pasta/scene.lua スケルトン作成
  - SCENEレジストリのメタテーブル定義
  - registry テーブル（階層構造）
...
- [x] 11.1 (P) pasta/areka/init.lua スケルトン作成
  - AREKAモジュールのスタブ定義
  - 将来の拡張ポイントコメント
  - _Requirements: 9.1, 9.3, 9.4_

- [x] 11.2 (P) pasta/shiori/init.lua スケルトン作成
  - SHIORIモジュールのスタブ定義
  - 将来の拡張ポイントコメント
