...
### 3. 設定プロパティの更新
- [x] 3.1 BuildConfigプロパティ名の変更
  - `spot_switch_newlines`を`spot_newlines`に変更
  - デフォルト値1.5を維持
  - _Requirements: 3.1, 3.2_

### 4. テストの更新と強化
- [x] 4.1 act_test.lua: トークン生成の検証
...
- [x] 4.4 sakura_builder_test.lua: 統合シナリオの検証
