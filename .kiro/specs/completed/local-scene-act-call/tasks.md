...
- [x] 1. (P) ローカルシーン Lua 関数名の命名規約を修正する
...
- [x] 2. (P) シーン検索の fn_name 変換とコメントを更新する
...
- [x] 4. (P) finalize 経路のローカルシーン検索テストを追加する
...
- [x] 5. ローカルシーン call の E2E 統合テストを作成する

- [x] 5.1 新規テストファイルを作成し、test runner に登録する
  - Task 1 と Task 2 の完了後に作業する
...
- [x] 5.2 単純なローカルシーン call のテストケースを実装する
