...
- [x] 1. (P) virtual_dispatcher モジュールの実装
- [x] 1.1 (P) モジュール構造とローカル変数の定義
...
- [x] 2. (P) second_change デフォルトハンドラの実装
- [x] 2.1 (P) OnSecondChangeハンドラの登録
...
- [x] 5. Luaユニットテストの実装
- [x] 5.1 (P) virtual_dispatcher_spec.lua作成
...
- [x] 6. 統合テスト・リグレッション検証
- [x] 6.1 既存shiori_event_testとの整合性確認
