...
- [x] 1. PastaShiori 構造体のフィールド変更
- [x] 1.1 (P) 新規フィールドの追加と既存フラグの削除
...
- [x] 1.2 (P) cache_shiori_functions メソッドの実装
...
- [x] 1.3 (P) clear_cached_functions メソッドの実装
...
- [x] 5. Drop impl への unload 機能追加
- [x] 5.1 unload 関数の安全な呼び出し
