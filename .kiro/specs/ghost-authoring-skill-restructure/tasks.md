...
- [ ] 2. (P) references/pasta-toml.md リファレンスファイルを新設する
- [ ] 2.1 ファイル骨格と概要セクションを作成する
...
- [ ] 2.2 エンジン正式解析5セクションの全キーを記載する
  ...
  - _Requirements: 3_
- [ ] 2.3 カスタムフィールド3セクションの全キーと BudouX 設定を記載する
...
- [ ] 3. (P) references/authoring-patterns.md を新設して §6 パターン集を移動する
- [ ] 3.1 ファイルを新設し §6.1〜§6.5 のパターンを移動する
...
- [ ] 4. SKILL.md を「要約 + リファレンスリンク」形式に再構成する（Task 1・2・3 完了後に実施）
- [ ] 4.1 §3.4 Variables の永続化説明を更新しクロスリファレンスリンクを追記する
  ...
  - _Requirements: 1_
- [ ] 4.2 §4 Project Structure の pasta.toml 記述を要約テーブルとリファレンスリンクに置き換える
  ...
  - _Requirements: 3_
- [ ] 4.3 §6 Authoring Patterns を要約テーブルと代表パターンに再構成する
  ...
  - _Requirements: 4_
- [ ] 4.4 §3・§5 の §6 内部相互参照を authoring-patterns.md アンカーリンクに更新し、バージョンをバンプする
...
- [ ] 5. 変更内容の整合性と行数目標を検証する
- [ ]* 5.1 SKILL.md の総行数とリンク到達可能性を確認する
  ...
  - _Requirements: 4_
- [ ]* 5.2 要件ごとの変更内容を照合して矛盾・漏れがないことを確認する
