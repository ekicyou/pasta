...
[LUA_COLIBK](06-standard-libraries.md#61--cコードでのライブラリのロード) · 
[LUA_DBLIBK](06-standard-libraries.md#61--cコードでのライブラリのロード) · 
[LUA_GLIBK](06-standard-libraries.md#61--cコードでのライブラリのロード) · 
[LUA_IOLIBK](06-standard-libraries.md#61--cコードでのライブラリのロード) · 
[LUA_LOADLIBK](06-standard-libraries.md#61--cコードでのライブラリのロード) · 
[LUA_MATHLIBK](06-standard-libraries.md#61--cコードでのライブラリのロード) · 
[LUA_OSLIBK](06-standard-libraries.md#61--cコードでのライブラリのロード) · 
[LUA_STRLIBK](06-standard-libraries.md#61--cコードでのライブラリのロード) · 
[LUA_TABLIBK](06-standard-libraries.md#61--cコードでのライブラリのロード) · 
[LUA_UTF8LIBK](06-standard-libraries.md#61--cコードでのライブラリのロード)
...
| ドキュメント | 説明 |
|-------------|------|
| [README.md](README.md) | 翻訳について・利用案内 |
