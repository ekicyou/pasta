========================================================================
    コンソール アプリケーション : cranberry プロジェクトの概要
========================================================================

AppWizard はユーザー用に cranberry アプリケーションを作成しました。  
このファイルには cranberry アプリケーションを構成している
各ファイルの概要が含まれています。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済みヘッダー (PCH) ファイル cranberry.pch、
