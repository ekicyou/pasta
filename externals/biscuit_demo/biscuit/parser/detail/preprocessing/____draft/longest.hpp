...
#line 94 "D:\\Application\\biscuit_0_90_0\\biscuit\\parser\\detail\\preprocessing\\longest.ipp"
template<
class P0
>
struct longest<
...
#line 34 "D:\\Application\\boost_1_32_0\\boost\\preprocessor\\iteration\\detail\\local.hpp"
if (P0::parse(s, us)) { ret = true; d = std::max( std::distance(cur0, s.cur), d ); } s.cur = cur0;
#line 111 "D:\\Application\\biscuit_0_90_0\\biscuit\\parser\\detail\\preprocessing\\longest.ipp"
if (ret) { std::advance(s.cur, d); } return ret;
}
};
#line 94 "D:\\Application\\biscuit_0_90_0\\biscuit\\parser\\detail\\preprocessing\\longest.ipp"
