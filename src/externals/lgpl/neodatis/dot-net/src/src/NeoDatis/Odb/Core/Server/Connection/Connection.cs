namespace NeoDatis.Odb.Core.Server.Connection
{
	public class Connection
	{
		...
		{
			if (obj == null || !(obj is NeoDatis.Odb.Core.Server.Connection.Connection))
			{
				return false;
			}
			NeoDatis.Odb.Core.Server.Connection.Connection c = (NeoDatis.Odb.Core.Server.Connection.Connection
				)obj;
